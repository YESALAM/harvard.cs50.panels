define(function(require, module, exports) {
    main.consumes = ["Panel", "ui", "fs", "commands"];
    main.provides = ["gitter50"];
    return main;
    ...
    function main(options, imports, register) {
        ...
        plugin.setCommand({
            name: "gitterCommand",
            hint: "Toggle CS50/x Gitter",
            bindKey: { mac: "Shift-Command-g", win: "Shift-Ctrl-G" }
        });
          
        });
    
        plugin.on("draw", function(e){
            e.html.innerHTML = "<div class='gitterChat'>helo</div>";
            ui.insertCss(require("text!./gitter.css"), options.staticPrefix, plugin);

            ((window.gitter = {}).chat = {}).options = {
                room: 'cs50/x',
                preload: true,
                showChatByDefault: true,
                targetElement: '.gitterChat'
            };
            getGitter();
        });
...
var sidecar = function(t) {
  ...
  var n = Object.prototype.toString,
    ...
    L = ["	\n\x0B\f\r Â áš€á Žâ€€â€â€‚â€ƒ", "â€„â€…â€†â€‡â€ˆâ€‰â€Šâ€¯âŸã€€\u2028", "\u2029\ufeff"].join(""),
    T = new RegExp("(^[" + L + "]+)|([" + L + "]+$)", "g"),
